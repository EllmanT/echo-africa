    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-100 rounded-3xl overflow-hidden"
          />
        </Card>
        <Card
          title="Build & Review"
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-pink-100 rounded-3xl overflow-hidden"
            colors={[
              [255, 166, 158],
              [221, 255, 247],
            ]}
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-sky-100 rounded-3xl overflow-hidden"
            colors={[[125, 211, 252]]}
          />
        </Card>
        <Card
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-violet-100 rounded-3xl overflow-hidden"
            colors={[[125, 211, 252]]}
          />
        </Card>
      </div>
    ...
    >
      ...
      <div className="relative z-20 px-10">
        ...
        <p
         ...
         relative z-10 mt-4 text-muted-foreground text-center
         group-hover/canvas-card:-translate-y-2 transition duration-200"
        >
          {des}
        </p>
  ...
  return (
    <div>
      ...
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px] ">
        ...
        justify-center rounded-full bg-white px-5 py-2 text-purple backdrop-blur-3xl font-bold text-2xl"
        >
          {order}
        </span>
      </button>
